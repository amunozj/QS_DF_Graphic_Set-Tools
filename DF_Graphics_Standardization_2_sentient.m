    ...
    if ncr>0
        ...
        for ipgs = 1:npgs
            ...
            if names_sw
                ...
                if npgs==1
                    FileO = [FolderO 'raw\graphics\QS_STD_TMP\' fl_name '_' num2str(tlsz(1)) 'x' num2str(tlsz(2)) '.png'];
                else
                    FileO = [FolderO 'raw\graphics\QS_STD_TMP\' fl_name num2str(ipgs) '_' num2str(tlsz(1)) 'x' num2str(tlsz(2)) '.png'];
                end
